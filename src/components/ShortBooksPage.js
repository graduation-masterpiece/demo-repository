  ...
  return (
    <div className="w-screen h-screen bg-[#ECE6CC] overflow-hidden mx-auto my-auto">
      ...
      <div className="flex flex-col w-[64vw] h-[90vh] mx-[18em] mt-[3em]">
                ...
                {currentSentenceIndex === 0 ? (
                  ...
                  <>
                    ...
                    <div className="absolute inset-0 bg-white opacity-70 z-10" />
                     {/* 여기 px 를 vh(세로) vw(가로) 수정 필요합니다.(로드 안되서 조정불가) */}
        ...
        <div className="fixed top-[55vh] right-[11vw] p-2 bg-[#C4D0B3] rounded-xl border-[2px] border-gray-600">
          <button className="bg-[#424141] rounded-xl p-4">
            <img src="/images/white_like.png" alt="like" className="w-8 h-8" />
          </button>
        </div>
        <div className="fixed top-[69vh] right-[11vw] p-2 bg-[#C4D0B3] rounded-xl border-[2px] border-gray-600">
          <button className="bg-[#424141] rounded-xl p-4">
            <img src="/images/share.png" alt="share" className="w-8 h-8" />
          </button>
        </div>
        <div className="fixed top-[83.4vh] right-[11vw] p-2 bg-[#C4D0B3] rounded-xl border-[2px] border-gray-600">
          <button className="bg-[#424141] rounded-xl p-4">
